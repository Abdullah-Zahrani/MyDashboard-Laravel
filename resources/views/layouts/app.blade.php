              ...
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a href="{{route('checkout')}}">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active text-white" aria-current="page" href="{{route('login')}}">تسجيل الدخول</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-white" href="{{route('register')}}">حساب جديد</a>
                    </li>
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        <li class="nav-item">
                            <a href="{{route('controlpanel')}}" class="nav-link align-middle px-0">
                              <i class="bi bi-diagram-2"></i> <span class="ms-1 d-none d-sm-inline text-white px-1">إضافة المنتجات</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{route('addgritem')}}" class="nav-link align-middle px-0">
                              <i class="bi bi-collection"></i> <span class="ms-1 d-none d-sm-inline text-white px-1">إضافة مجموعة</span>
                            </a>
